...
public class Monster {
	...
	public String toString() {
		if (dead == false) {
			...
			return name + " is dead and therefore has no stats";
		}
	}
	...
	public void attack(Player p) {
		if(frozen > 0){
			...
			if(frozen == 0){
				...
				System.out.println(name + " is still frozen");
			}
	...
	public void recieveDebuff(String debuff) {
		...
		if (debuff.equals("Frozen")) {
			...
			if (frozen > 0) {
				...
				System.out.println(getName() + " is not frozen");
			}
		}
	}
}
