...
public class Rogue extends Player {
	...
	public String toString(){
		if(!super.getDead()){
			return "The Sly Rick Astley, " + super.toString();
		} else{
	...
	public void printSpells() {
		System.out.println("Rick Astley characters do not use spells and only have passive traits");
		...
		if(super.getLevel() >= 2 && super.getLevel() < 10){
			...
			System.out.println(super.getName() + "has a 1/3 chance to dodge the attack and deal its damage to the monster");
			super.printSpells();
			System.out.println(super.getName() + "has a 1/5 chance to apply a poison debuff");
		}
